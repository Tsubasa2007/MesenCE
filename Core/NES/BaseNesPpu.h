...
protected:
	...
	bool _oamAddrEvaluationLeak = true; //2C02 leaves OAMADDR where sprite evaluation got to when rendering is turned off; see BaseMapper::EnablePpuOamAddrEvaluationLeak
