...
namespace Mesen.Interop
{
	public class EmuApi
	{
		...
		//that is not mounted. Returns how many sectors were written.
		[DllImport(DllPath)] public static extern UInt32 ExtractNesDiscItem([MarshalAs(UnmanagedType.LPUTF8Str)] string binPath, UInt32 lba, UInt32 sectors, UInt32 from, UInt32 to, [MarshalAs(UnmanagedType.I1)] bool retime, [MarshalAs(UnmanagedType.LPUTF8Str)] string outPath);
