		...
		public Control Build(object? data)
		{
			...
			if(mappings != null) {
				return mappings.Type switch {
					ControllerType.SnesController or ControllerType.SnesRumbleController or ControllerType.SnesBlueRetroController or ControllerType.SacController => new SnesControllerView(),
