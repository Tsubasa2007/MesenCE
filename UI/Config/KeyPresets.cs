...
namespace Mesen.Config
{
	public static class KeyPresets
	{
		public static void ApplyWasdLayout(KeyMapping m, ControllerType type)
		{
			...
			if(type == ControllerType.SnesController || type == ControllerType.SnesRumbleController || type == ControllerType.SnesBlueRetroController || type == ControllerType.SnesNttDataKeypad || type == ControllerType.SacController) {
		...
		public static void ApplyXboxLayout(KeyMapping m, int player, ControllerType type, bool altLayout = false)
		{
			...
			if(type == ControllerType.SnesController || type == ControllerType.PceAvenuePad6 || type == ControllerType.GbaController || type == ControllerType.SnesRumbleController || type == ControllerType.SnesBlueRetroController || type == ControllerType.SnesNttDataKeypad || type == ControllerType.SacController) {
